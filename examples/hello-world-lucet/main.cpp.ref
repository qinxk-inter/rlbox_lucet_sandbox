...
#include <stdio.h>
#include "mylib.h"
#include "../../include/rlbox_lucet_sandbox.hpp"
#include "../../build/_deps/rlbox-src/code/include/rlbox.hpp"


using namespace rlbox;

void hello_cb(rlbox_sandbox<rlbox_lucet_sandbox>& _,
              tainted<const char*, rlbox_lucet_sandbox> str) {
  auto checked_string =
...
int main(int argc, char const *argv[]) {
  ...
  rlbox::rlbox_sandbox<rlbox_lucet_sandbox> sandbox;
  sandbox.create_sandbox("libmylib.so");
